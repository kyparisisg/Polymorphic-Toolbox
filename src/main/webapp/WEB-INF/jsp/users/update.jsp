                    ...
                    <div class="col-lg-5 col-md-6 offset-lg-0 offset-md-3">
                        ...
                        <div class="card card-register">
                            ...
                            <div class="card-body">
                                ...
                                <%--                                            </div>--%>
                                <%--                                        </div>--%>
                                <%--                                            &lt;%&ndash;                                    <form:label type="text" id="datepicker" class="form-control datepicker" value="10/05/2016" data-datepicker-color="primary" path = "firstName">First Name</form:label></td>&ndash;%&gt;--%>
                                <%--                                            &lt;%&ndash;                                    <form:input path = "firstName"/></td>&ndash;%&gt;--%>
