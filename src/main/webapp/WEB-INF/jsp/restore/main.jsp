...
<div class="wrapper">
    <div class="page-header">
        ...
        <div class="content-center">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th scope="row">
                            ...
                            <label class="custom-control-label" for="tableDefaultCheck3">File</label>
                            </div>
                        </th>
                        <td>Mark</td>
                        <td>Otto</td>
            ...
            <div class="row row-grid justify-content-between align-items-center text-left">
                <h1 class="text-white">List of SERVERS
                    <br/>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            ...
                            <h5 class="card-category">Total Transfer History</h5>
                            <h2 class="card-title">Number of Data Transfered per month</h2>
                        </div>
                    </div>
                </div>
                <div class="card-body">
