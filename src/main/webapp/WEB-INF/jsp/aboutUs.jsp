...
<head>
    ...
    <!-- CSS Files -->
    <link href="/css/blk-design-system.min.css?v=1.0.0" rel="stylesheet" />
                ...
                <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                    <div class="card card-coin card-plain">
                        <div class="card-header">
                            ...
                            <h4 class="title">Project Lead/Back-End Developer</h4>
                        </div>
                        <div class="card-body">
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-6">
                    <div class="card card-coin card-plain">
                        <div class="card-header">
                            <img src="/images/aboutus/Tyler.jpg" class="img-center img-fluid rounded-circle">
                ...
                <div class="col-md-6">
                    <div class="card card-coin card-plain">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-tabs-primary justify-content-center">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#linkaBella">
                                        Contact
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#linkbBella">
                                        Send
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane" id="linkcBella">
                                    <div class="table-responsive">
                                        <table class="table tablesorter " id="plain-table">
                                            ...
                                            <tr>
                                                <td>
                                                    Full Name: Bella Yang
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    Email: bella.yang@temple.edu
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    Profession/Company: AI Engineer at Envision Pharma
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
...
<script src="/js/plugins/jquery.sharrre.min.js" type="text/javascript"></script>
<!-- Sharrre libray -->
